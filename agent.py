...
_knowledge_base_tool = QueryEngineTool.from_defaults(
    ...
    description=(
        "A vector database of knowledge about NLP techniques."
    ),
)
...
agent = ReActAgent(
    ...
    llm=llm,
    system_prompt=(
        "You are a helpful AI assistant with access to a vector database of knowledge about NLP techniques. "
        "When users ask questions about languages, models, techniques "
